...
from samples.automl_dogcat.tensorflow import automl_infer_c
import tests

class Testautoml_InferC(unittest.TestCase):
    ...
    def test_infer_c(self):
        res = tests.read_from_output(lambda: automl_infer_c.infer(image_path=self.image_input,
