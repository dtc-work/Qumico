...
class TestGenCOptimizeYad2K(unittest.TestCase):

    @classmethod
    def setUpClass(cls) -> None:
        cls.gen_c_path = os.path.abspath(gen_c_optimize.__file__)
        cls.output_path = os.path.join(os.path.dirname(cls.gen_c_path), "out_c_optimize")
