...
#backend_test.include('test_operator_add_broadcast_cpu')                     # BUG
#backend_test.include('test_operator_add_size1_broadcast_cpu')               # BUG
#backend_test.include('test_operator_add_size1_right_broadcast_cpu')         # BUG
#backend_test.include('test_operator_add_size1_singleton_broadcast_cpu')     # BUG
# backend_test.include('test_operator_addconstant_cpu')                      # BUG  
# backend_test.include('test_operator_addmm_cpu')                            # BUG
...
# backend_test.include('test_operator_max_cpu')                              # BUG
# backend_test.include('test_operator_maxpool_cpu')                          # BUG
# backend_test.include('test_operator_min_cpu')                              # BUG
# backend_test.include('test_operator_mm_cpu')                               # BUG
# backend_test.include('test_operator_non_float_params_cpu')                 # BUG
